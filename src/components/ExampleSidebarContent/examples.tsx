...
export const examples = [
  ...
  },
  {
    ...
    description: (
      <T>
        An emulator of a simple machine with 16 instructions, a maximum program
        length of 16, and 2? registers. Built by{" "}
        <a className="link" href={"https://dougallj.wordpress.com/"}>
          Dougall Johnson
        </a>
      </T>
    ),
